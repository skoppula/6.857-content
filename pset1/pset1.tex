...
B. There are four messages and three unique pads. $3 \choose 2 = 3$, so at least two messages will have the same two pads applied to them. If we XOR those two pads together, the pads will cancel.
