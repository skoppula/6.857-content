...
\item Not collision resistant. For any x1, x2, you can pick y1, y2 such that y1 = x1 xor x2 and y2 = 0. Then we clearly have a collision.
\item Not weak collision resistant. Given x = x1, x2, we can just find x' = x2, x1 which will collide. If x1 = x2, we can just use 0, 0.
\end{enumerate}
